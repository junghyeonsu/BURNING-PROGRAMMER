...
class RubyonRails extends Component {
  ...
  render() {
    ...
    const list = [
      /* image = 이미지
        imageText = 그 이미지 이름 */
        <DescriptionItem image={<img src={Image} alt="My Image"></img>} text={"Ruby on Rails"} />,
        ...
        /* link = a 태그 */
        <DescriptionItem link={ <a href="https://rubyonrails.org/" target="_blank">Ruby on Rails</a> } />,
