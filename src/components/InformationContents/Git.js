...
class Git extends Component {
  ...
  render() {
    ...
    const list = [
      /* image = 이미지
        imageText = 그 이미지 이름 */
        <DescriptionItem image={<img src={Image} alt="My Image"></img>} text={"Git"} />,

        /* informationTitle = 설명 위에 타이틀
           그리고 chileren으로 설명을 넘겨주어야함  */
        <DescriptionItem informationTitle="Git이란 무엇일까요?">
            Git은 분산형 버전 관리 시스템(VCS)입니다.<br /><br />
            ...
            관리하기 힘든데, 이와 같은 문제점들을 해결하기 위해 등장한 도구가 바로 "Git"입니다.
        </DescriptionItem>,
  
        /* link = a 태그 */
        <DescriptionItem link={ <a href="https://git-scm.com/" target="_blank">Git</a> } />,
        <DescriptionItem informationTitle="Git">,
        </DescriptionItem>,
