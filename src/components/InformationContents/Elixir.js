...
class Elixir extends Component {
  ...
  render() {
    ...
    const list = [
      /* image = 이미지
        imageText = 그 이미지 이름 */
        <DescriptionItem image={<img src={Image} alt="My Image"></img>} text={"Elixir"} />,
        ...
        /* link = a 태그 */
        <DescriptionItem link={ <a href="https://web.archive.org/web/20120418080914/http://elixir-lang.org/" target="_blank">Elixir</a> } />,
