...
class RaspberryPi extends Component {
  ...
  render() {
    ...
    const list = [
      /* image = 이미지
        imageText = 그 이미지 이름 */
        <DescriptionItem image={<img src={Image} alt="My Image"></img>} text={"Raspberry Pi"} />,
        ...
        /* link = a 태그 */
        <DescriptionItem link={ <a href="https://www.raspberrypi.org/" target="_blank">Raspberry Pi</a> } />,
